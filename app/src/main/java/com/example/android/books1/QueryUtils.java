...
public final class QueryUtils {
    ...
    private static List<Books> extractFeatureFromJson(String bookJSON) {
        ...
        try {
            ...
            // which represents a list of book.
            ...
            for (int i = 0; i < bookArray.length(); i++) {
                ...
                // key called "item", which represents a list of information
                // for that book.
                ...
                // Extract the value for the key called "url"(inside accessInfo key)
                JSONObject accessInfo = currentBook.getJSONObject("accessInfo");
                String url = accessInfo.getString("webReaderLink");

                // Create a new {@link Books} object with the author, title
